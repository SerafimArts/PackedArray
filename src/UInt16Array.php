 ...
 * @template-implements IntArrayInterface<int<0, 65535>>
 */
final class UInt16Array extends TypedArray implements IntArrayInterface
{
    /**
    ...
    /**
     * @return \Traversable<int<0, max>, int<0, 65535>>
     *
     * @psalm-suppress MoreSpecificReturnType : The type in the docblock is more
