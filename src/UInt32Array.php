...
final class UInt32Array extends TypedArray implements IntArrayInterface
{
     ...
     * @var int<0, 4294967295>
     */
    public const ELEMENT_MAX_VALUE = 4294967295;
    ...
    public static function new(
        ...
        assert($size >= 0, ArraySizeException::fromUnderflow('UInt32Array', $size));
    ...
    public function offsetGet(mixed $offset): int
    {
        ...
        return (int)(\unpack($this->endianness === Endianness::LITTLE ? 'V' : 'N', \substr($this->data, $offset, 4))[1]);
    }
    ...
    /**
     * @return \Traversable<int<0, max>, int<0, 4294967295>>
     *
     * @psalm-suppress MoreSpecificReturnType : The type in the docblock is more
    ...
    public function getIterator(): \Traversable
    {
        for ($offset = 0; $offset < $this->bytes; $offset += 4) {
            yield $offset => (int)(\unpack($this->endianness === Endianness::LITTLE ? 'V' : 'N', \substr($this->data, $offset, 4))[1]);
        }
    }
}
