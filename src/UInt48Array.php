 ...
 *
 * @template-extends TypedArray<int<0, 281474976710655>>
 * @template-implements IntArrayInterface<int<0, 281474976710655>>
 */
final class UInt48Array extends TypedArray implements IntArrayInterface
{
    /**
     ...
     * @var int<0, 281474976710655>
     */
    public const ELEMENT_MAX_VALUE = 281474976710655;
    ...
    public static function new(
        ...
        assert($size >= 0, ArraySizeException::fromUnderflow('UInt48Array', $size));
    ...
    /**
     * @param int<0, max> $offset
     * @param int<0, 281474976710655> $value
     */
    ...
    /**
     * @return \Traversable<int<0, max>, int<0, 281474976710655>>
     *
     * @psalm-suppress MoreSpecificReturnType : The type in the docblock is more
